...
import 'package:github_discover/src/presentation/blocs/repository/repositories_search_bloc.dart';
...
import '../../../blocs/repository/repositories_details_bloc.dart';
        ...
        return RepositoriesSearchPage(
          ...
          onDetailTap: (Repository repository) {
            context
                ...
                .add(const RepositoryLoadingEvent());
