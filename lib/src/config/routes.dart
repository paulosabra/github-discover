...
import '../presentation/pages/users/details/user_details_screen.dart';
import '../presentation/pages/users/search/users_search_screen.dart';
    ...
    GoRoute(
      ...
      routes: [
        ...
        GoRoute(
          ...
          builder: (context, state) => const RepoSearchScreen(),
          routes: [
            GoRoute(
              path: 'id',
