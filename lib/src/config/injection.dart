...
import 'package:github_discover/src/domain/usecases/profile/repositorys/get_repository_usecase.dart';
...
void startModules() {
  ...
  getIt.registerLazySingleton(() => GetRepositorysUseCase(
  ...
  getIt.registerFactory<RepositoriesSearchBloc>(() => RepositoriesSearchBloc(
        getRepositoriesUseCase: getIt<GetRepositorysUseCase>(),
      ));
