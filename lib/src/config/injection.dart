...
import 'package:github_discover/src/domain/usecases/users/get_user_usecase.dart';
...
import 'package:github_discover/src/domain/usecases/users/get_users_usecase.dart';
...
void startModules() {
  ...
  getIt.registerFactory<UsersSearchBloc>(() => UsersSearchBloc(getUsersUseCase: getIt<GetUsersUseCase>()));
}